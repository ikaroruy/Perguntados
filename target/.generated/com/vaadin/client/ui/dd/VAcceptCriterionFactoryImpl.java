...
public class VAcceptCriterionFactoryImpl extends com.vaadin.client.ui.dd.VAcceptCriterionFactory {
  public VAcceptCriterion get(String name) {
    ...
    else if ("com.vaadin.ui.CustomTable.TableDropCriterion" == name) return GWT.create(org.tepi.filtertable.gwt.client.ui.VFilterTable.VTableLazyInitItemIdentifiers.class );
