...
import static br.com.coelce.perguntados.model.Perfil.ADMIN;
import br.com.coelce.perguntados.model.Usuario;
import br.com.coelce.perguntados.persistence.UsuarioDAO;
...
//        layout.setSpacing(true);
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("Gestão de Questões da Cespe");
...
//        teste();
        ...
        if(user.getUsuario().getPerfil().equals(ADMIN)) {
        navigationEvent.fire(new NavigationEvent("questões"));
        } else {
            navigationEvent.fire(new NavigationEvent("provas"));
        }
    }
