...
public class PermissoesWindow extends Window implements Button.ClickListener {
    ...
    private BeanFieldGroup<Permissoes> binder;
    ...
    public void init() {
        ...
        binder = new BeanFieldGroup<>(Permissoes.class);
        binder.bindMemberFields(this);
    }

    public void create() {
        setCaption("Nova permissão");
        bindingFields(new Permissoes());
    ...
    public void edit(String id) {
        try {
            ...
            Permissoes m = container.getItem(id).getEntity();
            bindingFields(m);
    ...
    private void bindingFields(Permissoes m) {
