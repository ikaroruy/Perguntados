...
import br.com.coelce.anomalia.view.form.LocaisWindow;
 ...
 * @author dunkelheit
 */
@CDIView(LocaisView.VIEW_NAME)
public class LocaisView extends VerticalLayout implements View {

    private static final Logger LOGGER = Logger.getLogger(DiretoriaView.class.getSimpleName());
    public static final String VIEW_NAME = "locais";
    private Table table;
    @Inject
    private LocaisContainer container;
    @Inject
    private LocaisWindow locaisWindow;
    ...
    private Component buildToolbar() {
        ...
        Label title = new Label("Cadastro de locais");
...
//           createReport = buildCreateReport();
    ...
    private HorizontalLayout buildBarButtons(final JPAContainer datasource) {
        ...
        editButton.addClickListener(new Button.ClickListener() {
            ...
            @Override
            public void buttonClick(Button.ClickEvent event) {
                locaisWindow.edit(table.getValue().toString());
            }
        });
