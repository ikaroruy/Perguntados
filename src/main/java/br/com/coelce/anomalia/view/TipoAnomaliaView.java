 ...
 * @author dunkelheit
 */
@CDIView(TipoAnomaliaView.VIEW_NAME)
public class TipoAnomaliaView extends VerticalLayout implements View {

    private static final Logger LOGGER = Logger.getLogger(TipoAnomaliaView.class.getSimpleName());
    public static final String VIEW_NAME = "tipo de Anomalia";
    private Table table;
    @Inject
    private TipoAnomaliaContainer container;
    @Inject
    private TipoAnomaliaWindow tipoAnomaliaWindow;
    ...
    private Component buildToolbar() {
        ...
        Label title = new Label("Classificação das Anomalias");
