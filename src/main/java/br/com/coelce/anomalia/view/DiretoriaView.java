 ...
 * @author dunkelheit
 */
@CDIView(DiretoriaView.VIEW_NAME)
public class DiretoriaView extends VerticalLayout implements View {

    private static final Logger LOGGER = Logger.getLogger(DiretoriaView.class.getSimpleName());
    public static final String VIEW_NAME = "diretoria";
    private Table table;
    @Inject
    private DiretoriaContainer container;
    @Inject
    private DiretoriaWindow diretoriaWindow;
    ...
    private Component buildToolbar() {
        ...
        Label title = new Label("Cadastro de diretoria");
...
//        container.addNestedContainerProperty("diretoria.id");
    ...
    private HorizontalLayout buildBarButtons(final JPAContainer datasource) {
        ...
        editButton.addClickListener(new Button.ClickListener() {
            ...
            @Override
            public void buttonClick(Button.ClickEvent event) {
                diretoriaWindow.edit(table.getValue().toString());
            }
        });
