 ...
 * @author dunkelheit
 */
@CDIView(AreaView.VIEW_NAME)
public class AreaView extends VerticalLayout implements View {

    private static final Logger LOGGER = Logger.getLogger(AreaView.class.getSimpleName());
    public static final String VIEW_NAME = "área";
    private Table table;
    @Inject
    ...
    private Component buildToolbar() {
        ...
        Label title = new Label("Cadastro de áreas");
