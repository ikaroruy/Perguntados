 ...
 * @author dunkelheit
 */
@CDIView(ProcessoView.VIEW_NAME)
public class ProcessoView extends VerticalLayout implements View{
     private static final Logger LOGGER = Logger.getLogger(ProcessoView.class.getSimpleName());
    public static final String VIEW_NAME = "processos";
    private Table table;
    @Inject
    ...
    private Component buildToolbar() {
        ...
        Label title = new Label("Cadastro de processos");
...
//        tableReturn.setItemIcon(this, null);
    ...
    private HorizontalLayout buildBarButtons(final JPAContainer datasource) {
        ...
        editButton.addClickListener(new Button.ClickListener() {
            ...
            @Override
            public void buttonClick(Button.ClickEvent event) {
                processoWindow.edit(table.getValue().toString());
