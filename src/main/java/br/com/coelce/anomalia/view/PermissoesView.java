...
// * @author dunkelheit
// */
//@CDIView(PermissoesView.VIEW_NAME)
//public class PermissoesView extends VerticalLayout implements View {
//
//    private static final Logger LOGGER = Logger.getLogger(PermissoesView.class.getSimpleName());
//    public static final String VIEW_NAME = "permissões";
//    private Table table;
//    @Inject
//    private PermissaoContainer container;
//    @Inject
//    private PermissoesWindow permissoesWindow;
...
//
//        Label title = new Label("Cadastro de permissões");
...
//        tableReturn.setVisibleColumns(new Object[]{"tipoDePermissao"});
...
//                Or or = new Or(new Like("tipoDePermissao", event.getText() + "%"));
...
//            @Override
//            public void buttonClick(Button.ClickEvent event) {
//                permissoesWindow.edit(table.getValue().toString());
//            }
//        });
